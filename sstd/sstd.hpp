...
//    template <typename T> inline void           sort     (      std::vector<T>&  rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline std::vector<T> sorted   (const std::vector<T>&  rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline std::vector<T> sorted   (      std::vector<T>&& rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline void           sort_gr  (      std::vector<T>&  rhs); // Descending: 降順: 9, 8, 7, ...
//    template <typename T> inline std::vector<T> sorted_gr(const std::vector<T>&  rhs); // Descending: 降順: 9, 8, 7, ...
//    template <typename T> inline std::vector<T> sorted_gr(      std::vector<T>&& rhs); // Descending: 降順: 9, 8, 7, ...
