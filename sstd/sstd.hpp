...
//    template <typename T> inline void           sort_ow   (      std::vector<T>&  rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline std::vector<T> sort      (const std::vector<T>&  rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline std::vector<T> sort      (      std::vector<T>&& rhs); // Ascending: 昇順: 0, 1, 2, ...
//    template <typename T> inline void           sort_gr_ow(      std::vector<T>&  rhs); // Descending: 降順: 9, 8, 7, ...
//    template <typename T> inline std::vector<T> sort_gr   (const std::vector<T>&  rhs); // Descending: 降順: 9, 8, 7, ...
//    template <typename T> inline std::vector<T> sort_gr   (      std::vector<T>&& rhs); // Descending: 降順: 9, 8, 7, ...
