...
bool SwapByTwoIndex::getVal(class sstd::bitMatrix& bMat, uint& p, uint& q){
	...
	mask >>= 8*p_Mod8 + q_Mod8;

	return ((bMat.bMat8x8(p_Div8, q_Div8)&mask) != (uint64)0);
}


void SwapByTwoIndex::setVal(class sstd::bitMatrix& bMat, uint& p, uint& q, bool& val){
