...
int sstd__str2voidp(void* return_val_ptr, const int type, const std::vector<std::string>& v){
    ...
    switch(type){
    case sstd::num_bool      : { if(!sstd::str2val(*(                 bool   *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_char      : { if(!sstd::str2val(*(                 char   *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_int8      : { if(!sstd::str2val(*(                  int8  *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_int16     : { if(!sstd::str2val(*(                  int16 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_int32     : { if(!sstd::str2val(*(                  int32 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_int64     : { if(!sstd::str2val(*(                  int64 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_uint8     : { if(!sstd::str2val(*(                 uint8  *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_uint16    : { if(!sstd::str2val(*(                 uint16 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_uint32    : { if(!sstd::str2val(*(                 uint32 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_uint64    : { if(!sstd::str2val(*(                 uint64 *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_float     : { if(!sstd::str2val(*(                 float  *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_double    : { if(!sstd::str2val(*(                 double *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_str       : { if(!sstd::str2val(*(            std::string *)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_bool  : { if(!sstd::str2val(*(std::vector<     bool  >*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_char  : { if(!sstd::str2val(*(std::vector<     char  >*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_int8  : { if(!sstd::str2val(*(std::vector<      int8 >*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_int16 : { if(!sstd::str2val(*(std::vector<      int16>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_int32 : { if(!sstd::str2val(*(std::vector<      int32>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_int64 : { if(!sstd::str2val(*(std::vector<      int64>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_uint8 : { if(!sstd::str2val(*(std::vector<     uint8 >*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_uint16: { if(!sstd::str2val(*(std::vector<     uint16>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_uint32: { if(!sstd::str2val(*(std::vector<     uint32>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_uint64: { if(!sstd::str2val(*(std::vector<     uint64>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_float : { if(!sstd::str2val(*(std::vector<     float >*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_double: { if(!sstd::str2val(*(std::vector<     double>*)return_val_ptr, v)){return -1;} } break;
    case sstd::num_vec_str   : { if(!sstd::str2val(*(std::vector<std::string>*)return_val_ptr, v)){return -1;} } break;
    default: { return -2; }
    }
