...
void TEST__c2py__empty_args(const char* tmpDir){
    sstd::c2py<void> py_emptyArg(tmpDir, "test/src_test/python/c2py_t", "py_emptyArg", "void");
...
void TEST__c2py__bench_withoutInit(const char* tmpDir){
    ...
    sstd::c2py<void> py_empty(tmpDir, "test/src_test/python/c2py_t", "py_empty", "void");
...
void TEST__c2py__builIn_bool(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__builIn_char(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__builtIn_num(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__str(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__vec_bool(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__vec_char(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
                          ...
                          )
{
    ...
    {
        // void, vec<T>*
        sstd::c2py<void> pyFn(tmpDir, "test/src_test/python/c2py_t", "py_pVecFloatX", fmt_2); // Writing back
        std::vector<T> vecIn_buf = vecIn;
    ...
    {
        // void, vec<T>*|~
        sstd::c2py<void> pyFn(tmpDir, "test/src_test/python/c2py_t", "py_pVecFloatX_cnvBuiltin", fmt_3); // Writing back
        std::vector<T> vecIn_buf = vecIn;
    ...
    {
        // void, vec<T>*|*~
        sstd::c2py<void> pyFn(tmpDir, "test/src_test/python/c2py_t", "py_pVecFloatX_pCnvBuiltin", fmt_4); // Writing back
        std::vector<T> vecIn_buf = vecIn;
...
void TEST__c2py__vec_builtin(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__vec_str(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
                      ...
                      const char* fmt_0, const char* fmt_1, const char* fmt_2, const char* fmt_3, const char* fmt_4)
{
    ...
    std::string ans_plus = ans + ans_WB;
    {
        ...
        // sstd::c2py<sstd::mat<std::string>> py_matStr(tmpDir, "test/src_test/python/c2py_t", "py_matX", "mat<str>, mat<str>");
...
void TEST__c2py__mat_c(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
void TEST__c2py__return_null(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
    {
        // "return []"
...
void TEST__c2py__sample_codes(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
    {
...
//        mat_r2print(mat_rA);
    ...
    //---
    {
        ...
        imgPath2mat_rRGB(&imgR, &imgG, &imgB, "./test/src_test/test.png");
...
//---
void TEST__c2py__vvec_builtin(const char* tmpDir){
    const char* fileName = "test/src_test/python/c2py_t";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
//*
TEST(c2py, empty_args             ){ SET_TMP_DIR_NAME(); TEST__c2py__empty_args(tmpDir.c_str());           }
TEST(c2py, empty_args__other_dir  ){ SET_TMP_DIR_NAME(); TEST__c2py__empty_args__same_dir(tmpDir.c_str()); }
TEST(c2py, bench_withoutInit      ){ SET_TMP_DIR_NAME(); TEST__c2py__bench_withoutInit(tmpDir.c_str());    }
TEST(c2py, bench_withInit         ){ SET_TMP_DIR_NAME(); TEST__c2py__bench_withInit(tmpDir.c_str());       }
TEST(c2py, builIn_bool            ){ SET_TMP_DIR_NAME(); TEST__c2py__builIn_bool(tmpDir.c_str());          }
TEST(c2py, builIn_char            ){ SET_TMP_DIR_NAME(); TEST__c2py__builIn_char(tmpDir.c_str());          }
TEST(c2py, builtIn_num            ){ SET_TMP_DIR_NAME(); TEST__c2py__builtIn_num(tmpDir.c_str());          }
TEST(c2py, str                    ){ SET_TMP_DIR_NAME(); TEST__c2py__str(tmpDir.c_str());                  }
TEST(c2py, vec_bool               ){ SET_TMP_DIR_NAME(); TEST__c2py__vec_bool(tmpDir.c_str());             }
TEST(c2py, vec_char               ){ SET_TMP_DIR_NAME(); TEST__c2py__vec_char(tmpDir.c_str());             }
TEST(c2py, vec_builtin            ){ SET_TMP_DIR_NAME(); TEST__c2py__vec_builtin(tmpDir.c_str());          }
TEST(c2py, vec_str                ){ SET_TMP_DIR_NAME(); TEST__c2py__vec_str(tmpDir.c_str());              }
TEST(c2py, mat_c                  ){ SET_TMP_DIR_NAME(); TEST__c2py__mat_c(tmpDir.c_str());                }
TEST(c2py, mat_r                  ){ SET_TMP_DIR_NAME(); TEST__c2py__mat_r(tmpDir.c_str());                }
TEST(c2py, return_null            ){ SET_TMP_DIR_NAME(); TEST__c2py__return_null(tmpDir.c_str());          }
TEST(c2py, sample_codes           ){ SET_TMP_DIR_NAME(); TEST__c2py__sample_codes(tmpDir.c_str());         }
//*/

//TEST(c2py, vvec_bool              ){ SET_TMP_DIR_NAME(); TEST__c2py__vvec_bool(tmpDir.c_str());          } // not implimented
//TEST(c2py, vvec_char              ){ SET_TMP_DIR_NAME(); TEST__c2py__vvec_char(tmpDir.c_str());          } // not implimented
TEST(c2py, vvec_builtin           ){ SET_TMP_DIR_NAME(); TEST__c2py__vvec_builtin(tmpDir.c_str());        } // under construction #################
//TEST(c2py, vvec_str               ){ SET_TMP_DIR_NAME(); TEST__c2py__vvec_str(tmpDir.c_str());           } // not implimented
