...
TEST(math, sum){
    { std::vector<signed char> buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_EQ(sstd::sum(buf), -5); }
...
TEST(math, min_vec){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::min(buf)==-5); }
...
TEST(math, min_vec_abs){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::min_abs(buf)==0); }
...
TEST(math, max_vec){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::max(buf)==4); }
...
TEST(math, max_vec_abs){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::max_abs(buf)==-5); }
...
TEST(math, max_mat_c){
    { sstd::mat_c<signed char > buf={{-2, -1}, {0, 1}}; ASSERT_TRUE(sstd::max(buf)==1); }
...
TEST(math, max_mat_r){
    { sstd::mat_r<signed char > buf={{-2, -1}, {0, 1}}; ASSERT_TRUE(sstd::max(buf)==1); }
...
TEST(math, argmin_vec){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::argmin(buf)==0); }
...
TEST(math, argmin_vec_abs){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::argmin_abs(buf)==5); }
...
TEST(math, argmax_vec){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::argmax(buf)==buf.size()-1); }
...
TEST(math, argmax_vec_abs){
    { std::vector<signed char > buf={-5,-4,-3,-2,-1,0,1,2,3,4}; ASSERT_TRUE(sstd::argmax_abs(buf)==0); }
...
TEST(math, argmax_mat_c){
    { sstd::mat_c<signed char > buf={{-2, -1}, {0, 1}}; ASSERT_TRUE(sstd::argmax(buf)==3); }
...
TEST(math, argmax_mat_r){
    { sstd::mat_r<signed char > buf={{-2, -1}, {0, 1}}; ASSERT_TRUE(sstd::argmax(buf)==3); }
