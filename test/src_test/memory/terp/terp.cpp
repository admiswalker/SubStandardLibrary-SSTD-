...
//TEST(memory_terp, var_constructor_and_to_int64_min){ TEST_VAR_CONSTRUCTOR_AND_TO(int64, -9223372036854775808); } // Commenting out this line in order to suppress the bagged warning of GCC.
