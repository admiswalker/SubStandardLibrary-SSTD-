...
TEST(pdbg, pdbg){
    ...
    ASSERT_STREQ(testing::internal::GetCapturedStdout().c_str(), "\x1B[1m\x1B[31msrc_test/print/pdbg.cpp:14 TestBody(): \x1B[0mexample msg.");
    //  \u001b[31m  :  set output red
    //  \u001b[0m   :  reset color
}
TEST(pdbg, pdbg_err){
    ...
    ASSERT_STREQ(testing::internal::GetCapturedStdout().c_str(), "\x1B[1msrc_test/print/pdbg.cpp:21 TestBody(): \x1B[31merror: \x1B[0mexample err msg.");
    //  \u001b[31m  :  set output red
    //  \u001b[0m   :  reset color
}
TEST(pdbg, pdbg_if_true){
    ...
    ASSERT_STREQ(testing::internal::GetCapturedStdout().c_str(), "\x1B[1m\x1B[31msrc_test/print/pdbg.cpp:28 TestBody(): \x1B[0mexample msg.");
}
