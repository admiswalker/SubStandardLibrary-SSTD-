...
TEST(glob, glob_opt_f){
    const char* path = R"(./test/src_test/file/glob_test/*)";
    std::vector<std::string> v_path = sstd::glob(path, "f");

    // compare v_path with v_ans
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a.txt",
				    "./test/src_test/file/glob_test/a.zip",
				    "./test/src_test/file/glob_test/b.txt",
				    "./test/src_test/file/glob_test/b.zip",
				    "./test/src_test/file/glob_test/c.txt",
				    "./test/src_test/file/glob_test/c.zip"};
...
TEST(glob, glob_opt_f_txt){
    const char* path = R"(./test/src_test/file/glob_test/*.txt)";
    std::vector<std::string> v_path = sstd::glob(path, "f");
...
TEST(glob, glob_opt_f_zip){
    const char* path = R"(./test/src_test/file/glob_test/*.zip)";
    std::vector<std::string> v_path = sstd::glob(path, "f");

    // compare v_path with v_ans
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a.zip",
				    "./test/src_test/file/glob_test/b.zip",
				    "./test/src_test/file/glob_test/c.zip"};
    ASSERT_EQ(v_path.size(), v_ans.size());
    for(uint i=0; i<v_path.size(); ++i){
...
TEST(glob, glob_opt_d){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a",
				    "./test/src_test/file/glob_test/b",
				    "./test/src_test/file/glob_test/c"};
    ASSERT_EQ(v_path.size(), v_ans.size());
    for(uint i=0; i<v_path.size(); ++i){
	ASSERT_STREQ(v_path[i].c_str(), v_ans[i].c_str());
    }
...
TEST(glob, glob_opt_dr){
    ...
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a",
				    "./test/src_test/file/glob_test/b",
				    "./test/src_test/file/glob_test/c",
				    "./test/src_test/file/glob_test/c/ca",
				    "./test/src_test/file/glob_test/c/ca/caa"};
    ASSERT_EQ(v_path.size(), v_ans.size());
    for(uint i=0; i<v_path.size(); ++i){
	ASSERT_STREQ(v_path[i].c_str(), v_ans[i].c_str());
    }
...
TEST(glob, glob_opt_fr){
    ...
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a.txt",
				    "./test/src_test/file/glob_test/a.zip",
				    "./test/src_test/file/glob_test/a/a01.txt",
				    "./test/src_test/file/glob_test/a/a02.txt",
				    "./test/src_test/file/glob_test/a/a03.txt",
				    "./test/src_test/file/glob_test/b.txt",
				    "./test/src_test/file/glob_test/b.zip",
				    "./test/src_test/file/glob_test/b/b01.txt",
				    "./test/src_test/file/glob_test/b/b02.txt",
				    "./test/src_test/file/glob_test/b/b03.txt",
				    "./test/src_test/file/glob_test/c.txt",
				    "./test/src_test/file/glob_test/c.zip",
				    "./test/src_test/file/glob_test/c/c01.txt",
				    "./test/src_test/file/glob_test/c/c02.txt",
				    "./test/src_test/file/glob_test/c/c03.txt",
				    "./test/src_test/file/glob_test/c/ca/ca01.txt",
				    "./test/src_test/file/glob_test/c/ca/ca02.txt",
				    "./test/src_test/file/glob_test/c/ca/ca03.txt",
				    "./test/src_test/file/glob_test/c/ca/caa/caa01.txt",
				    "./test/src_test/file/glob_test/c/ca/caa/caa02.txt",
				    "./test/src_test/file/glob_test/c/ca/caa/caa03.txt"};
    ASSERT_EQ(v_path.size(), v_ans.size());
    for(uint i=0; i<v_path.size(); ++i){
	ASSERT_STREQ(v_path[i].c_str(), v_ans[i].c_str());
    }
...
TEST(glob, glob_opt_dfr){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a",
				    "./test/src_test/file/glob_test/a.txt",
				    "./test/src_test/file/glob_test/a.zip",
				    "./test/src_test/file/glob_test/a/a01.txt",
				    "./test/src_test/file/glob_test/a/a02.txt",
				    "./test/src_test/file/glob_test/a/a03.txt",
...
TEST(glob, glob_opt_dfpr_case02){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans={"./test/src_test/file/glob_test/a/a01.txt",
				    "./test/src_test/file/glob_test/a/a02.txt",
				    "./test/src_test/file/glob_test/a/a03.txt",
				    "./test/src_test/file/glob_test/b/b01.txt",
				    "./test/src_test/file/glob_test/b/b02.txt",
...
TEST(glob, glob_pt_opt_f){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans_path={"./test/src_test/file/glob_test/a.txt",
                                         "./test/src_test/file/glob_test/a.zip",
                                         "./test/src_test/file/glob_test/b.txt",
                                         "./test/src_test/file/glob_test/b.zip",
                                         "./test/src_test/file/glob_test/c.txt",
...
TEST(glob, glob_pt_opt_f_zip){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans_path={"./test/src_test/file/glob_test/a.zip",
                                         "./test/src_test/file/glob_test/b.zip",
                                         "./test/src_test/file/glob_test/c.zip"};
    std::vector<char> v_ans_type={'f',
                                  'f',
...
TEST(glob, glob_pt_opt_d){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans_path={"./test/src_test/file/glob_test/a",
                                         "./test/src_test/file/glob_test/b",
                                         "./test/src_test/file/glob_test/c"};
...
TEST(glob, glob_pt_opt_dfpr_case02){
    ...
    // compare v_path with v_ans
    std::vector<std::string> v_ans_path={"./test/src_test/file/glob_test/a/a01.txt",
                                         "./test/src_test/file/glob_test/a/a02.txt",
                                         "./test/src_test/file/glob_test/a/a03.txt",
                                         "./test/src_test/file/glob_test/b/b01.txt",
                                         "./test/src_test/file/glob_test/b/b02.txt",
