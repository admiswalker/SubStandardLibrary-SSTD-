...
clean:
	-rm -rf $(TARGET)
	@(cd ./sstd; make clean)
	-rm -rf ./sin.png             # test file generated by test/c2py
	-rm -rf ./sin_cos.png         # test file generated by test/c2py
	-rm -rf ./test_reCombined.png # test file generated by test/c2py
	-rm -rf ./test__writeAll_bin_char.png # test file generated by test/strEdit
	-rm -rf ./test__writeAll_bin_str.png  # test file generated by test/strEdit
